        ...
        builder: ((context, controller, child) => Scaffold(
              body: Padding(
                ...
                child: PageView(
                  ...
                  children: const [
                    PageTemplate(
                      title: 'Olá, bem-vindo ao iRamp',
                      lottiePath: Assets.eggLottie,
                      primaryButtonTitle: 'Começar',
                      subtitle:
                          'O iRamp é um app feito que todos possam contribuir',
                    ),
                    PageTemplate(
                      title: 'Cadastre uma rampa!',
                      primaryButtonTitle: 'Próximo',
                      lottiePath: Assets.eggRecipeLottie,
                      subtitle:
                          'Tire uma foto, cadastre sua rampa e contribua para o mapeamento das rampas em Garanhuns',
                    ),
                    PageTemplate(
                      title: 'É isso!',
                      ...
                      subtitle:
                          'Qualquer feedback é só nos contactar.',
                    ),
                  ],
                ),
              ),
