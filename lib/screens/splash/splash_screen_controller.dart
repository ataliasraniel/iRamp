...
class SplashScreenController {
  ...
  void initApplication(Function onComplete) async {
    ...
    await configDefaultAppSettings(onComplete);
  }

  Future configDefaultAppSettings(
    ...
    if (isFirstTime != null && isFirstTime) {
      ...
      await Future.delayed(
          Duration(seconds: 3), () => onComplete.call());
      ...
      //     print(user);
      //     navigatorKey.currentState!
      //         .pushNamed(Screens.signin);
      //   } else {
      //     log('user is not null, must push to home screen');
      //     onComplete();
      //   }
      //   print('finished checking user');
      // });
      // return;
    }
  }
